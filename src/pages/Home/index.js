...
<section className="hero" id="overlay"> 
    ...
    <section className="main" id="work"> 
        ...
        <div className="hometext1"> 
         ...
         <p> Apex Smoothies is a health-focused smoothie bar that wanted an app to expand their presence and branding. 
           ...
           <Link to="https://github.com/Meehan-007/Apex-Smoothie-" target="_blank" > <button className='mx-5' id="grovereg" type="submit"> View Project </button> </Link>
            </div>
        </div>
    ...
    <div className="hometext2"> 
     ...
     <p> The Book App is a web application that allows users to search for any book using a third-party API from Google. 
         With a simple search, users can find information about any book they want, including the title, author, and description.
        </p> 
        <div className='flex-row'> 
      <Link to="https://book-powers-4us.herokuapp.com/" target="_blank"> <button className='btn-S btn-alt' type="submit"> View Website </button> </Link> 
      <Link to="https://github.com/Meehan-007/hw21" target="_blank"> <button className='btn-S mx-2' type="submit"> View Project </button> </Link> 
        </div>
    </div> 
    ...
    <div className="hometext2"> 
     ...
     <p> Deep Thoughts is a social media application that enables users to share their 
        ...
        <div className='flex-row'> 
        <Link to="https://deep-thoughts-are-real.herokuapp.com/" target="_blank">   <button className='btn-S btn-alt' type="submit"> View Website </button> </Link>
        <Link to="https://github.com/Meehan-007/deep-thought-class" target="_blank">  <button className='btn-S mx-2' type="submit"> View Project </button> </Link>
        </div>
    </div> 
    ...
    <div className="hometext2"> 
     ...
     <p> This application is a parody app that satirizes the idea of topic-based social media apps. 
        ...
        <div className='flex-row'> 
        <Link to="https://pizza-hunt17.herokuapp.com/" target="_blank"> <button className='btn-S btn-alt' type="submit"> View Website </button> </Link>
        <Link to="https://github.com/Meehan-007/pizza-hunt" target="_blank"> <button className='btn-S mx-2' type="submit"> View Project </button> </Link>
        </div>
    </div> 
    ...
    <div className="hometext2"> 
     ...
     <p> This site allows you to see the weather for this week in any city or town located in the United states.
        </p> 

        <div className='flex-row'> 
       <Link to="https://meehan-007.github.io/week6_hw/" target="_blank"> <button className='btn-S btn-alt' type="submit"> View Website </button> </Link>
       <Link to="https://github.com/Meehan-007/week6_hw" target="_blank">  <button className='btn-S mx-2' type="submit"> View Project </button> </Link>
        </div>
    </div> 
